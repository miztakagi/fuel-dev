...
<div id="main">
    ...
    <div class="container">
        ...
        <!-- GRID -->
        <div class="uk-grid-width-1-1 uk-grid-width-small-1-2 uk-grid-width-medium-1-3 uk-grid-width-large-1-4 tm-grid-heights" data-uk-grid="{gutter: 20, controls: '#filter'}">
            <!-- INFO-BLOCK -->
